  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-fun-purple via-fun-pink to-fun-orange overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 right-1/3 w-72 h-72 bg-fun-green/30 rounded-full blur-3xl animate-float" />
      </div>

      {/* Main content */}
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-12">
        {/* Logo */}
        <AnimatedSection animation="bounce-in" delay={0}>
          <div className="mb-8">
            <div className="w-24 h-24 bg-white rounded-3xl shadow-fun-3d flex items-center justify-center animate-bounce-slow">
        ...
        {/* Footer */}
        <AnimatedSection animation="fade-in-up" delay={1050}>
